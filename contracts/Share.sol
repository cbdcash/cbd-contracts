...
contract Share is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 50,000 sBDO
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 42500 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 3750 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 3240 ether;
    ...
    constructor() public ERC20("sCBD", "sCBD") {
        _mint(msg.sender, 510 ether);
        devFund = msg.sender;
    }
