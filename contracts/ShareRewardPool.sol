...
contract ShareRewardPool {
    ...
    IERC20 public sbdo = IERC20(0x7a0fFA3db812701e711fc38eacb99675352f31be);
    ...
    uint256 public sbdoPerBlock = 0.004 ether;
    ...
    constructor(address _sbdo, uint256 _startBlock) public {
        require(block.number < _startBlock, "late");
        if (_sbdo != address(0)) sbdo = IERC20(_sbdo);
        startBlock = _startBlock; // supposed to be 3,496,900 (Mon Dec 28 2020 15:00:00 UTC)
        endBlock = startBlock + runningBlocks; // 14,121,900 (Sat Jan 01 2022 20:45:00 UTC)
        operator = msg.sender;
    }
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: _lastRewardBlock, accSbdoPerShare: 0, isStarted: _isStarted}));
        if (_isStarted) {
